...
(let ((class '((class color) (min-colors 89)))
      (fg1 (if (display-graphic-p) "#f8f8f2" "#ffffff"))
      (fg2 (if (display-graphic-p) "#e2e2dc" "#d7d7d7"))
      (fg3 (if (display-graphic-p) "#ccccc7" "#d7d7d7"))
      (fg4 (if (display-graphic-p) "#b6b6b2" "#afafaf"))
      (bg1 (if (display-graphic-p) "#282a36" "#303030"))
      (bg2 (if (display-graphic-p) "#373844" "#5f5f5f"))
      (bg3 (if (display-graphic-p) "#464752" "#5f5f5f"))
      (bg4 (if (display-graphic-p) "#565761" "#5f5f5f"))
      (bg5 (if (display-graphic-p) "#44475a" "#5f5f5f"))
      (key2 (if (display-graphic-p) "#0189cc" "#0087d7"))
      (key3 (if (display-graphic-p) "#ff79c6" "#ff87d7"))
      (builtin (if (display-graphic-p) "#ffb86c" "#ffaf5f"))
      (keyword (if (display-graphic-p) "#ff79c6" "#ff87d7"))
      (const   (if (display-graphic-p) "#8be9fd" "#87d7ff"))
      (comment (if (display-graphic-p) "#6272a4" "#5f5faf"))
      (func    (if (display-graphic-p) "#50fa7b" "#5fff87"))
      (str     (if (display-graphic-p) "#f1fa8c" "#ffff87"))
      (type    (if (display-graphic-p) "#bd93f9" "#af87ff"))
      (var     (if (display-graphic-p) "#f8f8f2" "#ffffff"))
      (warning (if (display-graphic-p) "#ffb86c" "#ffaf5f"))
      (rainbow-1 (if (display-graphic-p) "#f8f8f2" "#ffffff"))
      (rainbow-2 (if (display-graphic-p) "#8be9fd" "#87d7ff"))
      (rainbow-3 (if (display-graphic-p) "#bd93f9" "#af87ff"))
      (rainbow-4 (if (display-graphic-p) "#ff79c6" "#ff87d7"))
      (rainbow-5 (if (display-graphic-p) "#ffb86c" "#ffaf5f"))
      (rainbow-6 (if (display-graphic-p) "#50fa7b" "#5fff87"))
      (rainbow-7 (if (display-graphic-p) "#f1fa8c" "#ffff87"))
      (rainbow-8 (if (display-graphic-p) "#0189cc" "#0087d7"))
      (rainbow-9 (if (display-graphic-p) "#ff5555" "#ff5f5f"))
      (eph-verbatim (if (display-graphic-p) "#f1fa8c" "#ffff87"))
      (eph-code (if (display-graphic-p) "#ff79c6" "#ff87d7")))

  (custom-theme-set-faces
   'dracula
   ;; default
   `(cursor ((,class (:background ,fg3))))
   `(default ((((type nil)) (:background "#303030" :foreground ,fg1))
