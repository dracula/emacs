...
(let ((colors '((fg1          "#f8f8f2")      ; Assigment form: VARIABLE COLOR [TTY-COLOR]
      ...
      (faces '(;; default
	       ...
	       (gnus-summary-high-unread :foreground ,keyword :weight bold)
               (gnus-summary-high-read :inherit gnus-summary-normal-unread :weight normal)
	       (gnus-summary-high-ancient :inherit gnus-summary-normal-read)
               (gnus-summary-high-ticked :inherit gnus-summary-normal-read :underline t)
	       ...
	       (gnus-summary-low-unread :foreground ,comment :weight bold)
               (gnus-summary-low-read :inherit gnus-summary-normal-unread :weight normal)
	       (gnus-summary-low-ancient :inherit gnus-summary-normal-read)
               (gnus-summary-low-ticked :inherit gnus-summary-normal-read :underline t)
